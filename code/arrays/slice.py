...
def get_element_range(arr: array, range: SliceRange):
    return arr[range.start : range.end]


if __name__ == "__main__":
    n_el: int = 100_000_000
    arr: array = array("i", [0] * n_el)  # "i" = signed int
    ...
    times = [get_element_range(arr, slice_range)[0] for slice_range in ranges]

    plot_title = "Slicing Time vs Slice Size in an array of 100M elements, slicing from the beginning"
    plot_graph(
    ...
    plot_title = "Slicing Time vs Slice Position in an array of 100M elements, for a slice Size of 1M elements"
