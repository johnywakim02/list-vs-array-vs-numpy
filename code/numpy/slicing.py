...
def get_element_range(arr: np.ndarray, range: SliceRange):
...
if __name__ == "__main__":
    ...
    plot_title = "Slicing Time vs Slice Size in a NumPy array of 100M elements, slicing from the beginning"
    plot_graph(
    ...
    plot_title = "Slicing Time vs Slice Position in a NumPy array of 100M elements, for a slice size of 1M elements"
